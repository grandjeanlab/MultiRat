...
## Bash environement
- [RABIES Version: 0.1.3](https://github.com/CoBrALab/RABIES) (see dependencies and install procedures)  
- FSL Version: 6.0.1  
- AFNI Version: AFNI_20.2.00  
...
Below is an example of a corrected structural image. Note how the **S**uperior, **I**mferior, **A**nterior, **P**osterior axis labels are indicated in `fsleyes`. 
...
# Testing RABIES
This section is meant to try RABIES with rat data and this template. It will not be kept in later versions.

```{bash test RABIES, eval=FALSE}
source bash_env.sh
